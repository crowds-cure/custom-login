...
const residencyProgram = [{
  ...
  "value": "4200312010",
  "label": "Creighton University School of Medicine/St Joseph's Medical Center (Phoenix) Program"
}, {
  "value": "4200321011",
  ...
  "value": "4201212054",
  "label": "Memorial Health- University Medical Center/Mercer { University School of Medicine (Savannah) Program"
}, {
  "value": "4201221052",
  ...
  "value": "4201621217",
  "label": "Advocate Health Care (Advocate Illinois Masonic Medical Center) Program"
}, {
  "value": "4201621243",
  ...
  "value": "4203512254",
  "label": "Zucker School of Medicine at Hofstra/Northwell at Staten Island University Hospital Program"
}, {
  "value": "4203521126",
  "label": "Montefiore Medical Center/Albert Einstein College of Medicine Program"
}, {
  "value": "4203521129",
  ...
  "value": "4203521218",
  "label": "Zucker School of Medicine at Hofstra/Northwell at Lenox Hill Hospital Program"
}, {
  "value": "4203521221",
  ...
  "value": "4203821153",
  "label": "Case Western Reserve University/University Hospitals Cleveland Medical Center Program"
}, {
  "value": "4203821156",
  ...
  "value": "4204111174",
  "label": "Sidney Kimmel Medical College at Thomas Jefferson University{ /TJUH Program"
}, {
  "value": "4204121162",
  ...
  "value": "4204121169",
  "label": "Drexel University College of Medicine/Hahnemann University { Hospital Program"
}, {
  "value": "4204121170",
  ...
  "value": "4204131171",
  "label": "Pennsylvania Hospital of the University of Pennsylvania { Health System Program"
}, {
  "value": "4204221182",
  ...
  "value": "4204811198",
  "label": "Texas A&M College of Medicine-Scott and White Medical Center (Temple) Program"
}, {
  "value": "4204812257",
  ...
  "value": "4204821197",
  "label": "University of Texas Health Science Center San Antonio Joe { and Teresa Lozano Long School of Medicine Program"
}, {
  "value": "4204821248",
  ...
  "value": "4205622212",
  "label": "Medical College of Wisconsin Affiliated Hospitals (St Joseph's) Program"
}, {
  "label": "Afghanistan",
  "value": "AF"
}, {
...
const sortArray = (array, findGroupIndex, compareMethod) => {
  const groupedArraysToSort = [];
  
  if(findGroupIndex) {
    for(let it = 0; it < array.length; it++) {
      const currentElement = array[it];
      const groupIndex = findGroupIndex(currentElement);

      if(!groupedArraysToSort[groupIndex]) {
        groupedArraysToSort[groupIndex] = [];
      }

      groupedArraysToSort[groupIndex].push(currentElement);
    }
  } else {
    groupedArraysToSort[0] = array;
  }

  for(let groupIt=0; groupIt < groupedArraysToSort.length; groupIt++) {
    if(groupedArraysToSort[groupIt]) {
      groupedArraysToSort[groupIt].sort(compareMethod);
    }
  }

  return groupedArraysToSort.flat();
};

const residencyProgramSortingConfig = () => {
  const findGroupIndex = (entry) => {
    if(entry.value === "notApplicable") {
      return 0;
    }

    // hospital entry will contain a number on value key
    if(!isNaN(Number(entry.value))){
      return 1;
    }

    // rest to be 2. In this case country.
    return 2;

  };
  const compareMethod = (entryA, entryB) => {

    if (entryA.label > entryB.label) {
      return 1;
    }
    if (entryA.label < entryB.label) {
      return -1;
...
const _residencyProgramSortingConfig = residencyProgramSortingConfig();
const residencyProgramSorted = sortArray(residencyProgram, _residencyProgramSortingConfig.findGroupIndex, _residencyProgramSortingConfig.compareMethod);


fs.writeFile('sorted.js', JSON.stringify(residencyProgramSorted), function (err) {
  if (err) throw err;
  console.log('Saved!');
});